...
wget https://s3imagepipeline.s3.amazonaws.com/Apps/Agent-PGPCore-RedHat_EL8-20.0.0-3964.x86_64.rpm

echo "Enable DSA FIPS mode ..."
echo "FIPSMode=1" >> /etc/ds_agent.conf
sudo rpm -ihv Agent-PGPCore-RedHat_EL8-20.0.0-3964.x86_64.rpm